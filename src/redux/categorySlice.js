...
const mockApi = {
    fetchCategories: () => Promise.resolve([{ id: 1, name: 'Category ww', imageUrl: 'url1', isActive: true }, { id: 2, name: 'Category 55', imageUrl: 'url2', isActive: false }]),
    ...
    extraReducers: (builder) => {
      builder
        ...
        .addCase(fetchCategories.fulfilled, (state, action) => {
          console.log("ratee",action.payload);
